...
{
  ptrToFindRecordBySurnameForm_ =
    std::make_unique<FindRecordBySurnameForm>(this);
...
MainWindow::on_pushButton_7_clicked()
{
  ptrToSortEmployeedRecordsBySalaryForm_ =
    std::make_unique<SortEmployeesRecordsBySalaryForm>();
...
MainWindow::on_pushButton_8_clicked()
{
  ptrToRemoveStudentRecordByIndexForm_ =
    std::make_unique<RemoveStudentRecordByIndexForm>();
...
MainWindow::on_pushButton_9_clicked()
{
  ptrToModifySalaryInEmployeeRecordForm_ =
    std::make_unique<ModifySalaryInEmployeeRecordForm>();
...
void
MainWindow::on_pushButton_11_clicked()
{
...
void
MainWindow::on_pushButton_12_clicked()
{
