...
public:
  Person(const std::string &name, const std::string &surname,
         const std::string &adress, const std::string &PESEL, const Sex &sex,
         const Position &position)
      : name_(name), surname_(surname), adress_(adress), PESEL_(PESEL),
        sex_(sex), position_(position) {}
  ...
  std::map<Sex, std::string> sexPrint{{Sex::male, "male"},
                                      {Sex::female, "female"}};
  std::map<Position, std::string> positionPrint{
      {Position::Student, "Student"}, {Position::Employee, "Employee"}};
